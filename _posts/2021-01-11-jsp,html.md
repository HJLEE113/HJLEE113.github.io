...
select deptno, max(sal), min(sal) from emp group by deptno having AVG(sal)>9000; //오류
...
[##_Image|kage@nrgDY/btqS4LKpBZt/cImEE2PhKOHmZyks175hO0/img.png|alignCenter|data-origin-width="0" data-origin-height="0" data-ke-mobilestyle="widthContent"|||_##]
...
[##_Image|kage@DSVze/btqS6XcSoCQ/Nw2Vub75NtJOhnzEjZ3Iv0/img.png|alignLeft|data-origin-width="0" data-origin-height="0" data-ke-mobilestyle="widthContent"|||_##]

## 2. 위를 프로그래밍 하시오

\-객체로 만들며, 쿼리는 insert문을 사용하시면 됩니다.

[##_Image|kage@nRDUW/btqTjDRvZFy/Yf178PMkD0YNxPIGPnANb0/img.png|alignCenter|data-origin-width="0" data-origin-height="0" width="400" data-ke-mobilestyle="widthContent"|||_##][##_Image|kage@digIsQ/btqS3IUGTUo/tkkaddiRZbFNTV8q9izchK/img.png|alignCenter|data-origin-width="0" data-origin-height="0" data-ke-mobilestyle="widthContent"|||_##]